...
public class Sapling implements Executable, Entity, Transformable, Positionable, Active, Health, Animate{
    ...
    public boolean transform(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        Entity miner = Functions.createDudeNotFull(this.getId(),
                ...
                this.resourceLimit, this.resourceCount,this.actionPeriod,
